...
class Assert
{
     ...
     * @var array
     */
    protected static $classMap = ['Collection' => '\\Api20\\Libraries\\Assert\\Assertions\\CollectionAssertions', 'String' => '\\Api20\\Libraries\\Assert\\Assertions\\StringAssertions', 'Object' => '\\Api20\\Libraries\\Assert\\Assertions\\ObjectAssertions', 'Integer' => '\\Api20\\Libraries\\Assert\\Assertions\\IntegerAssertions', 'Float' => '\\Api20\\Libraries\\Assert\\Assertions\\FloatAssertions', 'DateTime' => '\\Api20\\Libraries\\Assert\\Assertions\\DateTimeAssertions', 'FileUpload' => '\\Api20\\Libraries\\Assert\\Assertions\\FileUploadAssertions', 'Generic' => '\\Api20\\Libraries\\Assert\\Assertions\\GenericAssertions'];
    protected static $filterByType = ['NULL' => ['Generic', 'String', 'Integer', 'Float', 'Object', 'DateTime', 'Collection'], 'integer' => ['Integer', 'Generic', 'String'], 'double' => ['Float', 'Generic', 'String'], 'string' => ['String', 'DateTime', 'Generic', 'FileUpload'], 'object' => ['DateTime', 'Object', 'Generic', 'Collection'], 'array' => ['Collection', 'Generic']];
    /**
     * @var array
     */
    protected static $methods = ['istitlecase' => ['String'], 'iscamelcase' => ['String'], 'isunderscore' => ['String'], 'ispalindrome' => ['String'], 'isjson' => ['String'], 'iscreditcard' => ['String'], 'isinnextweek' => ['DateTime'], 'isinweek' => ['DateTime'], 'isinlastweek' => ['DateTime'], 'isinlastmonth' => ['DateTime'], 'isinmonth' => ['DateTime'], 'isinnextmonth' => ['DateTime'], 'isinlastyear' => ['DateTime'], 'isinyear' => ['DateTime'], 'isinnextyear' => ['DateTime'], 'isfirsthalfofyear' => ['DateTime'], 'issecondhalfofyear' => ['DateTime'], 'istrimesterofyear' => ['DateTime'], 'isquarterofyear' => ['DateTime'], 'isdaylightsavingtime' => ['DateTime'], 'isfuturedate' => ['DateTime'], 'ispastdate' => ['DateTime'], 'islatitude' => ['String'], 'islongitude' => ['String'], 'isrequired' => ['Generic'], 'isnotnull' => ['Generic'], 'notequals' => ['Generic'], 'greaterthanorequal' => ['Generic'], 'greaterthan' => ['Generic'], 'lessthanorequal' => ['Generic'], 'lessthan' => ['Generic'], 'isstring' => ['String'], 'isalphanumeric' => ['String'], 'isalpha' => ['String'], 'isbetween' => ['DateTime', 'String', 'Integer', 'Float'], 'isdaterange' => ['DateTime'], 'ischarset' => ['String'], 'isallconsonants' => ['String'], 'contains' => ['String', 'Collection'], 'iscontrolcharacters' => ['String'], 'isdigit' => ['String'], 'endswith' => ['String', 'Collection'], 'equals' => ['String'], 'in' => ['String'], 'hasgraphicalcharsonly' => ['String'], 'haslength' => ['String', 'Collection'], 'islowercase' => ['String'], 'notempty' => ['String'], 'nowhitespace' => ['String'], 'hasprintablecharsonly' => ['String'], 'ispunctuation' => ['String'], 'matchesregex' => ['String'], 'isslug' => ['String'], 'isspace' => ['String'], 'startswith' => ['String', 'Collection'], 'isuppercase' => ['String'], 'isversion' => ['String'], 'isvowel' => ['String'], 'ishexdigit' => ['String'], 'haslowercase' => ['String'], 'hasuppercase' => ['String'], 'hasnumeric' => ['String'], 'hasspecialcharacters' => ['String'], 'isemail' => ['String'], 'isurl' => ['String'], 'isuuid' => ['String'], 'isobject' => ['Object'], 'isinstanceof' => ['Object'], 'hasproperty' => ['Object'], 'hasmethod' => ['Object'], 'hasparentclass' => ['Object'], 'ischildof' => ['Object'], 'inheritsfrom' => ['Object'], 'hasinterface' => ['Object'], 'isinteger' => ['Integer'], 'isfloat' => ['Float'], 'isnotzero' => ['Integer', 'Float'], 'ispositiveorzero' => ['Integer', 'Float'], 'ispositive' => ['Integer', 'Float'], 'isnegativeorzero' => ['Integer', 'Float'], 'isnegative' => ['Integer', 'Float'], 'isodd' => ['Integer', 'Float'], 'iseven' => ['Integer', 'Float'], 'ismultiple' => ['Integer', 'Float'], 'isfileuploaded' => ['FileUpload'], 'isfileuploadedbetweenfilesize' => ['FileUpload'], 'hasfileuploadedfilenameformat' => ['FileUpload'], 'hasfileuploadedvaliduploaddirectory' => ['FileUpload'], 'isfileuploadednotoverwritingexistingfile' => ['FileUpload'], 'hasfileuploadedfilenamelength' => ['FileUpload'], 'isfileuploadedimage' => ['FileUpload'], 'isfileuploadedmimetype' => ['FileUpload'], 'isdatetime' => ['DateTime'], 'isafter' => ['DateTime'], 'isbefore' => ['DateTime'], 'isweekend' => ['DateTime'], 'isweekday' => ['DateTime'], 'ismonday' => ['DateTime'], 'istuesday' => ['DateTime'], 'iswednesday' => ['DateTime'], 'isthursday' => ['DateTime'], 'isfriday' => ['DateTime'], 'issaturday' => ['DateTime'], 'issunday' => ['DateTime'], 'istoday' => ['DateTime'], 'isyesterday' => ['DateTime'], 'istomorrow' => ['DateTime'], 'isleapyear' => ['DateTime'], 'ismorning' => ['DateTime'], 'isafternoon' => ['DateTime'], 'isevening' => ['DateTime'], 'isnight' => ['DateTime'], 'isarray' => ['Collection'], 'each' => ['Collection'], 'haskeyformat' => ['Collection'], 'haskey' => ['Collection'], 'isnotempty' => ['Collection'], 'isscalar' => ['Generic'], 'nullorisscalar' => ['Generic'], 'ishexcolor' => ['String'], 'isipaddress' => ['String'], 'isipv4address' => ['String'], 'isipv6address' => ['String'], 'istimestring' => ['String'], 'isdatestring' => ['String']];
    /**
     * @param $method
     * @param $args
     *
