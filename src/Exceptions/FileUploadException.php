 ...
 */
namespace Xooxx\Assert\Exceptions;
...
class FileUploadException extends AssertionException
{
     ...
     * @var array
     */
    private $errorMessages = [UPLOAD_ERR_INI_SIZE => self::ASSERT_UPLOAD_ERR_INI_SIZE, UPLOAD_ERR_FORM_SIZE => self::ASSERT_UPLOAD_ERR_FORM_SIZE, UPLOAD_ERR_PARTIAL => self::ASSERT_UPLOAD_ERR_PARTIAL, UPLOAD_ERR_NO_FILE => self::ASSERT_UPLOAD_ERR_NO_FILE, UPLOAD_ERR_NO_TMP_DIR => self::ASSERT_UPLOAD_ERR_NO_TMP_DIR, UPLOAD_ERR_CANT_WRITE => self::ASSERT_UPLOAD_ERR_CANT_WRITE, UPLOAD_ERR_EXTENSION => self::ASSERT_UPLOAD_ERR_EXTENSION];
    /**
